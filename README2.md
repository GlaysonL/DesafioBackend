# Desafio backend ****U.
Seja muito bem-vindo ao desafio backend da ****U, obrigado pelo interesse em fazer parte do nosso time e ajudar a melhorar a vida de milhares de pessoas.
...
- Faça um clone do repositório em seu git pessoal para iniciar o desenvolvimento e não cite nada relacionado a ****U.
- Após teste realizado, favor encaminha-lo via Link abaixo:
Link: [Formulário - ****U - Desafio Backend(REMOVIDO A PEDIDO)]
...
https://app.swaggerhub.com/apis-docs/****U/****U_desafio_backend/1.0.0
